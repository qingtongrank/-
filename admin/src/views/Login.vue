    ...
    <div class="a">
        ...
        <ul class="form-box">
            <li>
                ...
                <div class="content">
                    <input v-model="adminId" type="text" placeholder="请输入管理员账号" />
                </div>
            </li>
            <li>
...
const login = () => {
    ...
    axios.get(`/AdminController/getAdminByIdByPass`, {
        params: {
        ...
        if (admin) {
            setSessionStorage('token', admin.token);
            admin.adminPassword = '';
            setSessionStorage('admin', admin.admin);
